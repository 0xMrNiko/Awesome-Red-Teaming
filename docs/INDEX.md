...
Fast navigation by topic. Pick the area you need and jump directly into the resource page.
...
- [Framework Scanner / Exploitation](topics/framework-scanner-exploitation.md)
- [Web Vulnerability Scanner / Burp Plugins](topics/web-vulnerability-scanner-burp-plugins.md)
- [File / Directory / Parameter discovery](topics/file-directory-parameter-discovery.md)
- [Crawler](topics/crawler.md)
- [Web Exploitation Tools](topics/web-exploitation-tools.md)
- [REST API Audit](topics/rest-api-audit.md)
- [SAML Login](topics/saml-login.md)
...
- [Loader / Packer / Injectors](topics/loader-packer-injectors.md)
- [EDR Evasion - Logging Evasion](topics/edr-evasion-logging-evasion.md)
- [Obfuscation](topics/obfuscation.md)
- [Useful Binary Modification tools](topics/useful-binary-modification-tools.md)
- [Command & Control Frameworks](topics/command-and-control-frameworks.md)
...
- [Network- / Service-level Vulnerability Scanner](topics/network-service-level-vulnerability-scanner.md)
- [Wifi Tools](topics/wifi-tools.md)
- [Wireless / Radio Exploitation](topics/wireless-radio-exploitation.md)
- [Bluetooth / low energy](topics/bluetooth-low-energy.md)
...
- [Hash Crack / Decryption](topics/hash-crack-decryption.md)
- [Hash Crack / Lookup](topics/hash-crack-lookup.md)
- [Exploit Search](topics/exploit-search.md)
...
- [JMX Exploitation](topics/jmx-exploitation.md)
- [Big-IP Exploitation](topics/big-ip-exploitation.md)
- [Citrix Netscaler Pwn](topics/citrix-netscaler-pwn.md)
- [mikrotik pwn](topics/mikrotik-pwn.md)
- [Redis Exploitation](topics/redis-exploitation.md)
- [Apache Tomcat Exploitation](topics/apache-tomcat-exploitation.md)
- [SSRF Exploitation](topics/ssrf-exploitation.md)
- [LFI exploitation](topics/lfi-exploitation.md)
- [XXE](topics/xxe.md)
- [Elasticsearch / Kibana Exploitation](topics/elasticsearch-kibana-exploitation.md)
- [RMI attacks](topics/rmi-attacks.md)
- [JSON Web Token Analysis / Exploitation](topics/json-web-token-analysis-exploitation.md)
- [PHP exploits](topics/php-exploits.md)
- [ASPX Webshells](topics/aspx-webshells.md)
...
- [Other Tool-Lists / Cheat Sheets](topics/other-tool-lists-cheat-sheets.md)
- [Resource](topics/resource.md)
- [OSCP Lists / tools / help](topics/oscp-lists-tools-help.md)
- [MISC](topics/misc.md)
- [Anonymous / Tor Projects](topics/anonymous-tor-projects.md)
- [APT / Malware Emulation / Defense Check](topics/apt-malware-emulation-defense-check.md)
- [Physical Security / HID/ETH Emulator](topics/physical-security-hid-eth-emulator.md)
- [Social Engeneering](topics/social-engeneering.md)
- [Android](topics/android.md)
- [Android / Nethunter](topics/android-nethunter.md)
- [Linux MacOSX Specific](topics/linux-macosx-specific.md)
- [Raspberri PI Exploitation](topics/raspberri-pi-exploitation.md)
- [VBA](topics/vba.md)
- [Rust](topics/rust.md)
- [Go](topics/go.md)
- [Nim](topics/nim.md)
...
- [Scanner / Exploitation-Frameworks / Automation](topics/scanner-exploitation-frameworks-automation.md)
